...
const ProjectGallery = ({ formData, handleAddGalleryImage, handleDeleteGalleryImage }) => {
  ...
  return (
    <div className="user--addProperty-sectionPadding flex flex-col rounded-xl border border-lightGrey bg-white md:flex-row md:items-start">
      ...
      <div className="mt-4 flex flex-col gap-y-4 md:ms-auto md:mt-0 md:w-[72%] md:flex-row md:gap-x-3 lg:gap-x-5 xl:gap-x-7 2xl:gap-x-8 flex-wrap">
