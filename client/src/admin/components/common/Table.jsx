    ...
    <table className="flex w-full flex-col gap-y-2.5">
      <thead className="bg-white">
        <tr className="flex items-center text-[14px]">
          ...
          <th className="w-[18%] text-start">Property</th>
          {type !== "properties" && (
            <th className="w-[20%] text-start">User</th>
          )}
          <th className="w-[18%] text-start">Location</th>

          {type === "properties" ? (
            <>
              <th className="w-[10%] text-start">Date Added</th>
              <th className="w-[8%] text-start">Featured</th>
              <th className="w-[22%] text-start">Tags</th>
            </>
          ) : (
            <>
      ...
      <tbody className="flex flex-col gap-y-2.5">
        <tr className="divide-platinum flex items-center divide-x bg-white py-2 text-[14px]">
          ...
          <td className="w-[18%] px-4 text-start">
            <div className="flex items-center gap-x-4">
              ...
              <div>
                <p className="font-regular text-[16px]">Single Row Middle</p>
                <p className="space-x-1 divide-x divide-black text-[12px]">
          ...
          {type !== "properties" && (
            <td className="w-[20%] px-4 text-start">
              <div className="flex flex-col text-davyGrey">
                <span className="text-[14px]">Ali Mustafa</span>
                <span className="text-[10px]">ali.mustafa@gmail.com</span>
              </div>
            </td>
          )}
          <td className="w-[18%] px-4 text-start">
            <div className="flex items-center gap-x-2 text-davyGrey">
              <LocationPin />
              <p className="text-[14px]">Marina Bay</p>
            </div>
          </td>

          {type === "properties" ? (
            <>
              <td className="w-[10%] px-4 text-start text-[14px] text-davyGrey">
                February 5th, 2024
              </td>
              <td className="w-[8%] px-4 text-start text-[14px] text-davyGrey">
                Yes
              </td>
              <td className="w-[22%] px-4 text-start">
          ...
          <td className="w-[18%] px-4 text-start">
            <div className="flex items-center gap-x-2 font-medium">
              <span className="text-[12px] text-davyGrey">Starting From</span>
              <span className="text-[16px]">{formatCurrency(3500000)}</span>
            </div>
          </td>
