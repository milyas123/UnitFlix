...
const ProjectCard = () => {
  const textSizes = "md:text-[7px] lg:text-[10px] xl:text-[12px] 2xl:text-[15px]";

  return (
    <div className="md:w-[170px] md:rounded-md lg:w-[220px] xl:w-[270px] 2xl:w-[320px] 2xl:rounded-xl shadow-lg">
      <div className="relative">
        <img
          className="w-full md:h-[140px] md:rounded-md lg:h-[190px] lg:rounded-lg xl:h-[250px] 2xl:h-[310px] 2xl:rounded-xl object-cover"
          src="/assets/imgs/discover.jpg"
          alt="Dubai South"
        />
        <div className="absolute z-[300] bg-white shadow-lg md:left-2 md:right-2 md:-bottom-16 md:p-2 md:rounded-md lg:left-3.5 lg:right-3.5 lg:-bottom-14 lg:rounded-lg lg:p-3 xl:right-5 xl:left-5 xl:-bottom-16 2xl:left-6 2xl:right-6 2xl:p-3.5 2xl:-bottom-24 2xl:rounded-xl">
