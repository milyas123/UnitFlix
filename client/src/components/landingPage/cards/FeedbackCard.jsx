...
const FeedbackCard = () => {
  return (
    <div className="border rounded-xl shadow-xl flex flex-col w-full p-4 gap-6 md:gap-1.5 md:w-[170px] md:p-3 lg:gap-3.5 lg:w-[270px] lg:p-4 xl:gap-5 xl:p-6 xl:w-[350px] 2xl:gap-6 2xl:w-[400px] 2xl:p-8">
    <div className="font-semibold flex flex-col gap-3 md:gap-1.5 lg:gap-2.5 xl:gap-3.5 2xl:gap-y-5">
    ...
    <div className="border-t flex items-center pt-4 gap-x-2 md:pt-2 lg:pt-3 xl:pt-5 2xl:pt-6 md:gap-x-1 lg:gap-x-2 xl:gap-x-3 2xl:gap-x-4">
