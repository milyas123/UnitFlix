const HelpInfoCard = ({ content }) => {
  ...
  return (
    <div
      className={`bg-white shadow-md flex flex-col rounded-xl p-3.5 pb-6 gap-4 md:gap-2 md:rounded-md md:p-2 md:h-[100px] md:w-[200px] lg:gap-3 lg:rounded-lg lg:p-3 lg:h-[140px] lg:w-[240px] xl:gap-7 xl:p-4 xl:h-[180px] xl:w-[320px] 2xl:gap-14 2xl:rounded-xl 2xl:p-5 2xl:h-[280px] 2xl:w-[400px] ${textSizes}`}
    >
