  ...
  return (
    <footer>
      ...
      <div className="bg-mirage text-white">
        <div className="w-full px-2 md:px-0 md:w-[65%] mx-auto py-16 md:py-24 flex flex-col md:flex-row gap-10 justify-between items-center">
          <div className="w-full flex flex-col gap-8 md:gap-7 lg:gap-9 xl:gap-12 2xl:gap-14">
            <div className="flex items-center gap-1.5">
              <img
                src="/assets/imgs/Logo.png"
                className="object-cover size-[60px] md:size-[35px] lg:size-[42px] xl:size-[50px] 2xl:size-[60px]"
                alt=""
              />
              <p className="font-semibold whitespace-nowrap text-[30px] md:text-[14px] lg:text-[18px] xl:text-[24px] 2xl:text-[30px]">
                UnitFlix
              </p>
            </div>

            <div className="flex justify-between items-center md:gap-10 md:px-2.5">
          ...
          <div className="w-full flex flex-col items-start md:items-center">
            <div className="space-y-3.5 md:space-y-2 lg:space-y-2.5 xl:space-y-3.5 2xl:space-y-4">
              ...
              {quickLinks.map((quickLink, index) => (
                <p
                  key={index}
                  className="text-[14px] md:text-[7px] lg:text-[9px] xl:text-[11px] 2xl:text-[14px] text-slate cursor-pointer hover:text-white transition-all duration-200 ease-in-out"
                >
                  {quickLink}
                </p>
              ))}
          ...
          <div className="w-full">
            <h4 className="font-semibold text-[15px] md:text-[8px] lg:text-[10px] xl:text-[12px] 2xl:text-[15px] mb-6">
              Get In Touch
            </h4>
            <form className="flex flex-col gap-y-2.5 md:gap-y-1.5 lg:gap-y-2 xl:gap-y-3 2xl:gap-y-4">
              <div className="relative flex items-center">
                ...
                />
                <UserRound
                  className="absolute left-1.5 md:left-2 2xl:left-3 text-grey"
                  size={17}
                />
              </div>
              <div className="relative flex items-center">
              ...
              <div className="relative flex items-center">
                ...
                <BiMessageSquareDetail
                  className="absolute left-1.5 top-4 md:top-2 2xl:top-2.5 md:left-2 2xl:left-3 text-grey"
                  size={20}
                />
              </div>
