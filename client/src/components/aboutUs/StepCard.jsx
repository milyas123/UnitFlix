const StepCard = ({ number }) => {
  return (
    <div className="shadow-right flex flex-col rounded-lg text-start md:w-[215px] md:gap-y-1.5 md:p-2 lg:w-[265px] lg:gap-y-2 lg:p-2.5 xl:w-[350px] xl:gap-y-2.5 xl:p-3 2xl:w-[425px] 2xl:p-4">
