const AboutCard = ({ imgSrc, title, description }) => {
  return (
    <div className="flex flex-col justify-end items-center text-center w-[300px] mx-auto md:mx-0 gap-2.5 md:w-[100px] md:gap-2 lg:w-[130px] lg:gap-2.5 xl:w-[160px] xl:gap-3 2xl:gap-4 2xl:w-[250px]">
