...
const ProjectCard = ({ project }) => {
  ...
  return (
    <div className="shadow-lg md:w-[95%] md:max-w-[190px] md:rounded-md lg:w-[99%] lg:max-w-[250px] xl:max-w-[295px] 2xl:max-w-[400px] 2xl:rounded-xl cursor-pointer" onClick={() => navigate(`/property-details/${project.id}`)}>
      <div className="relative">
        ...
        />
        <div
            className="absolute -bottom-[90px] left-4 right-4 z-[300] rounded-xl bg-white px-3 py-4 shadow-lg md:-bottom-16 md:left-2 md:right-2 md:rounded-md md:p-2 lg:-bottom-14 lg:left-3.5 lg:right-3.5 lg:rounded-lg lg:p-3 xl:-bottom-16 xl:left-5 xl:right-5 2xl:-bottom-24 2xl:left-6 2xl:right-6 2xl:rounded-xl 2xl:p-3.5">
          <h2
