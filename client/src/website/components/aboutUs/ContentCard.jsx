...
const ContentCard = ({ header, title, description, titleSize }) => {
  return (
    <div className="shadow-pastelGrey space-y-1.5 rounded-lg p-3.5 shadow md:space-y-2.5 md:p-2 lg:space-y-3 lg:p-3 xl:space-y-4 xl:p-3.5 2xl:space-y-5 2xl:p-4 h-full">
