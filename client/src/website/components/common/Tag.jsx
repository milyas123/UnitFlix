const Tag = ({color, text, children, textColor}) => {
    return (
        <div className={`rounded-sm flex items-center gap-x-1 text-[16px] md:text-[12px] lg:text-[13px] xl:text-[14px] 2xl:text-[16px] relative overflow-hidden`} style={{color: textColor ? textColor : color}}>
